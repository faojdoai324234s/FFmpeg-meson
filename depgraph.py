...
GRAPH = {'aac_adtstoasc_bsf': {'select': ['adts_header', 'mpeg4audio']},
 ...
 'atomics_native': {'if_any': ['atomics_gcc', 'atomics_suncc', 'atomics_win32']}, # MANUAL
 ...
 'av1_d3d12va_hwaccel': {'deps': ['d3d12va', 'dxva_picparams_av1'],
                         'select': ['av1_decoder']},
 'av1_decoder': {'select': ['atsc_a53', 'cbs_av1', 'dovi_rpu']},
 ...
 'dnn': {'deps': ['avformat', 'swscale'],
         'suggest': ['libtensorflow', 'libopenvino', 'libtorch']},
 ...
 'iamfdec': {'select': ['iso_media', 'mpeg4audio']},
 ...
 'libdav1d_decoder': {'deps': ['libdav1d'], 'select': ['atsc_a53', 'dovi_rpu']},
 ...
 'mov_demuxer': {'select': ['iso_media', 'riffdec', 'iamfdec'],
                 'suggest': ['zlib']},
 ...
 'mxf_muxer': {'select': ['pcm_rechunk_bsf', 'rangecoder']},
 ...
 'qrencode_filter': {'deps': ['libqrencode', 'swscale']}, # MANUAL
 'qrencodesrc_filter': {'deps': ['libqrencode', 'swscale']}, # MANUAL
 'qsv': {'deps': ['libmfx']},
